      ...
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center gap-8 text-[11px] font-medium tracking-wider">
          ...
          <a href="tel:+916267276957" className="flex items-center gap-2 hover:text-[#BFA37E] transition-colors">
            ...
            +91 62672 76957 / +91 96302 52729 / +91 72258 88650
          </a>
        </div>
        
        <div className="flex items-center gap-6">
          <a href="https://wa.me/916267276957" target="_blank" rel="noopener noreferrer" className="hover:text-[#25D366] transition-colors">
          ...
          <a href="https://www.instagram.com/hoteltenontenstays/" target="_blank" rel="noopener noreferrer" className="hover:text-[#BFA37E] transition-colors"><Instagram size={14} /></a>
        </div>
      </div>
    </div>
  );
