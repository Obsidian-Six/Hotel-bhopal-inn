    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-[#0A192F] mb-6">Perfectly Located in Bhopal City Centre</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-0 shadow-2xl rounded-sm overflow-hidden border border-slate-100">
          {/* Map Embed */}
          <div className="w-full lg:w-3/5 h-[500px]">
            <iframe 
          ...
          {/* Distance List */}
          <div className="w-full lg:w-2/5 p-10 bg-[#0A192F] text-white flex flex-col justify-between">
            <div>
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="mt-12 flex items-center justify-center gap-3 bg-[#BFA37E] text-white py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-[#0A192F] transition-all shadow-xl"
            >
